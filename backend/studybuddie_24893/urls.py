"""studybuddie_24893 URL Configuration
...
admin.site.site_header = "Studybuddie"
admin.site.site_title = "Studybuddie Admin Portal"
admin.site.index_title = "Studybuddie Admin"

# swagger
api_info = openapi.Info(
    title="Studybuddie API",
    default_version="v1",
    description="API documentation for Studybuddie App",
)
